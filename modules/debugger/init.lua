...
--   * _`...`_: Any arguments passed to [`start()`]().
...
--
--   * _`lexer`_: The lexer name of the language being debugged.
--   * _`...`_: Any arguments passed to [`continue()`]().
...
--
--   * _`lexer`_: The lexer name of the language being debugged.
--   * _`...`_: Any arguments passed to [`step_into()`]().
...
--
--   * _`lexer`_: The lexer name of the language being debugged.
--   * _`...`_: Any arguments passed to [`step_over()`]().
...
--
--   * _`lexer`_: The lexer name of the language being debugged.
--   * _`...`_: Any arguments passed to [`step_out()`]().
...
--
--   * _`lexer`_: The lexer name of the language being debugged.
--   * _`...`_: Any arguments passed to [`pause()`]().
...
--
--   * _`lexer`_: The lexer name of the language being debugged.
--   * _`...`_: Any arguments passed to [`restart()`]().
...
--   * _`...`_: Any arguments passed to [`stop()`]().
...
--     depends on the stack levels given to [`update_state()`]().
...
-- queues up the event to run in [`start()`]().
...
-- This only starts a debugger. [`continue()`](), [`step_into()`](), or
-- [`step_over()`]() should be called next to begin debugging.
